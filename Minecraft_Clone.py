...
player.gravity = 0.2
window.title = 'Minecraft by LalitCodes'
...
diamond_texture = load_texture('diamond_block.png')
diamondSpecular_texture = load_texture('diamondSpecular_block.png')
Glowstone_texture = load_texture('Glowstone_block.png')
